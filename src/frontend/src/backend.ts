...
import type { OrderStatus as _OrderStatus, ServiceOrder as _ServiceOrder, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createAccount(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createAccount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCategories(): Promise<Array<ServiceCategory>> {
        if (this.processError) {
            try {
    ...
    async getMyOrders(): Promise<Array<ServiceOrder>> {
        if (this.processError) {
            try {
    ...
    async getServicesByCategory(arg0: bigint): Promise<Array<SmmService>> {
        if (this.processError) {
            try {
...
function from_candid_ServiceOrder_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ServiceOrder): ServiceOrder {
...
function from_candid_vec_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ServiceOrder>): Array<ServiceOrder> {
    return value.map((x)=>from_candid_ServiceOrder_n7(_uploadFile, _downloadFile, x));
}
